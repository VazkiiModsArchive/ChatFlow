...
public class GuiEditor extends GuiScreen {
    ...
    public void initGui() {
        ...
        int border = 60;
        nameField = new GuiTextField(0, fontRendererObj, border, 70, width - border * 2, 12);
        matcherField = new GuiTextField(0, fontRendererObj, border, 110, width - border * 2, 12);
        replacementField = new GuiTextField(0, fontRendererObj, border, 150, width - border * 2, 12);
        testField = new GuiTextField(0, fontRendererObj, border, 240, width - border * 2, 12);
